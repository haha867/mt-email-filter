"""
Django settings for efu_app project.
...
WSGI_APPLICATION = 'efu_app.wsgi.application'


# Database
# https://docs.djangoproject.com/en/3.2/ref/settings/#databases

# Psycopg2 - python package for postgre database
DATABASES = {
    'default': {
...
AUTH_USER_MODEL = 'efu_auth.ApiUser'
